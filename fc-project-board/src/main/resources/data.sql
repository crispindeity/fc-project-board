...
insert into user_account (created_at, created_by, modified_at, modified_by, email, memo, nick_name, user_id, user_password)
values (now(), 'uno',  now(), 'uno', 'uno@mail.com', 'I am Uno.', 'Uno', 'uno', 'asdf1234')
;
